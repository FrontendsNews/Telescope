...
Template["userInvites"] = new Template("Template.userInvites", (function() {                                        // 3
  ...
  return HTML.DIV({                                                                                                 // 5
    ...
    return [ "\n          ", HTML.TR("\n            ", HTML.TD(Blaze.View(function() {                              // 48
...
Template[getTemplate('userInvites')].helpers({                                                                      // 15
  canCurrentUserInvite: function () {                                                                               // 16
    ...
    return currentUser && (currentUser.inviteCount > 0 && canInvite(currentUser));                                  // 18
  },                                                                                                                // 19
...
AutoForm.hooks({                                                                                                    // 40
  inviteForm: {                                                                                                     // 41
    onSuccess: function(operation, result, template) {                                                              // 42
      clearSeenMessages();                                                                                          // 43
                                                                                                                    // 44
      if(result && result.newUser){                                                                                 // 45
        flashMessage('An invite has been sent out. Thank you!', "success");                                         // 46
      } else {                                                                                                      // 47
        flashMessage('Thank you!', "info");                                                                         // 48
      }                                                                                                             // 49
      scrollUp();                                                                                                   // 50
    },                                                                                                              // 51
                                                                                                                    // 52
    onError: function(operation, error, template) {                                                                 // 53
      clearSeenMessages();                                                                                          // 54
                                                                                                                    // 55
      if(error && error.reason){                                                                                    // 56
        flashMessage(error.reason, "error");                                                                        // 57
        scrollUp();                                                                                                 // 58
      }                                                                                                             // 59
    }                                                                                                               // 60
  }                                                                                                                 // 61
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                  //
// packages/telescope-invites/Users/thinkxl/Development/apps/Frontends2/packages/telescope-invites/i18n/de.i18n.js  //
//                                                                                                                  //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                    //
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                  //
// packages/telescope-invites/Users/thinkxl/Development/apps/Frontends2/packages/telescope-invites/i18n/en.i18n.js  //
//                                                                                                                  //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                    //
var _ = Package.underscore._,                                                                                       // 1
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                  //
// packages/telescope-invites/Users/thinkxl/Development/apps/Frontends2/packages/telescope-invites/i18n/es.i18n.js  //
//                                                                                                                  //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                    //
var _ = Package.underscore._,                                                                                       // 1
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                  //
// packages/telescope-invites/Users/thinkxl/Development/apps/Frontends2/packages/telescope-invites/i18n/fr.i18n.js  //
//                                                                                                                  //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                    //
var _ = Package.underscore._,                                                                                       // 1
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                  //
// packages/telescope-invites/Users/thinkxl/Development/apps/Frontends2/packages/telescope-invites/i18n/it.i18n.js  //
//                                                                                                                  //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                    //
var _ = Package.underscore._,                                                                                       // 1
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                  //
// packages/telescope-invites/Users/thinkxl/Development/apps/Frontends2/packages/telescope-invites/i18n/zh-CN.i18n. //
//                                                                                                                  //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                    //
var _ = Package.underscore._,                                                                                       // 1
